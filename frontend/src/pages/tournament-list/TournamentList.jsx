...
export default function TournamentList() {
  ...
  function loadMoreActive() {
    ...
    Promise.all([
      ...
      .then(([upcomingData, inProgressData]) => {
        setActive((prev) => [...prev, ...(upcomingData.results || []), ...(inProgressData.results || [])]);
  ...
  function loadMorePast() {
    ...
    Promise.all([
      ...
      .then(([completedData, cancelledData]) => {
        setPast((prev) => [...prev, ...(completedData.results || []), ...(cancelledData.results || [])]);
    ...
    <div className="tournaments">
      ...
      <section className="tournaments__section">
        ...
        {active.length < activeTotal && (
          <div className="tournaments__load-more">
            <button className="tournaments__load-more-btn" onClick={loadMoreActive} disabled={activeIsLoadingMore}>
      ...
      <section className="tournaments__section">
        ...
        {past.length < pastTotal && (
          <div className="tournaments__load-more">
            <button className="tournaments__load-more-btn" onClick={loadMorePast} disabled={pastIsLoadingMore}>
      ...
      >
        ...
        {t.trophy?.title && (
          <div className="tournaments__card-trophy">
            {t.trophy.imageUrl && (
              <img src={t.trophy.imageUrl} alt={t.trophy.title} className="tournaments__card-trophy-img" />
            )}
