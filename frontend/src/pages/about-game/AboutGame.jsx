    ...
    <div className="about-game">
      ...
      <section className="about-game__section">
        ...
        <ol className="about-game__list">
          <li>Five of a Kind</li><li>Four of a Kind</li><li>Full House</li>
          <li>Straight (straights variant only)</li><li>Three of a Kind</li>
          <li>Two Pair</li><li>One Pair</li><li>High Card</li>
        </ol>
      </section>
      <section className="about-game__section">
        <h2>Game variants on PokerDados</h2>
        <p>Every game uses a three-part format: <strong>Best of 3, 5 or 7</strong> rounds, <strong>straights allowed or not</strong>, and a time limit of <strong>10, 30 or 90 seconds</strong> total.</p>
      </section>
    </div>
  );
}
